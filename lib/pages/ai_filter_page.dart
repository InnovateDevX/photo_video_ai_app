            ...
            Expanded(
              child: switch (_pageState) {
                _PageState.loading => AILoadingScreen(
                    ...
                    aiTips: AppStrings.stickerAiTips.map((e) => e.i18n()).toList(), // Reusing tips for now
  ...
  Widget _buildCustomNav(bool isDark) {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          _navCircleBtn(isDark, Icons.arrow_back_ios_new, () => Navigator.pop(context)),
          Expanded(
            child: Column(
              children: [
                Text(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
                        ...
                        : Center(
                            child: Column(
                                ...
                                children: [
                                  ...
                                  Text('tap_to_select_gallery'.i18n(),
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 8),
                      Text('ai_suggestion'.i18n(),
                          style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.textColor(isDark))),
                    ],
                  ),
                  const SizedBox(height: 8),
                  Container(
                    ...
                    child: Text('ai_filter_suggestion'.i18n(),
                        style: TextStyle(fontSize: 12, color: AppColors.secondaryTextColor(isDark))),
                  )
                ],
              ),
            ),
            SizedBox(height: h * 0.02),
            // Artistic Style
            Text('artistic_style'.i18n(),
                style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: AppColors.textColor(isDark))),
            SizedBox(height: h * 0.015),
            SizedBox(
              height: 140,
              child: _styles.isEmpty 
              ? Center(child: Text("No styles configured", style: TextStyle(color: Colors.grey[500])))
              : ListView.builder(
                            ...
                            child: ClipRRect(
                              ...
                              child: style.thumbnailUrl.isNotEmpty 
                                ? CachedNetworkImage(
                                    ...
                                    errorWidget: (context, url, err) => Container(color: Colors.grey[400], child: const Icon(Icons.style)),
                                  )
            ...
            GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: ProGradientDecoration(borderRadius: BorderRadius.all(Radius.circular(w * 0.08))),
                  child: Center(
                    child: Text(
